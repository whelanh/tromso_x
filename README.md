...
**Status: 2026-06-29: Builds successfully and boots to a working KDE Plasma 6.7.90 Wayland desktop
with functional application launcher, KRunner, Discover (Flatpak only), and Flatpak support.
