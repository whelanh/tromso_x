...
**Status: 2026-07-01: Builds successfully and deploys via `bootc switch` to a bootable system.
KDE Plasma 6.7.90 Wayland desktop with functional application launcher, KRunner,
Discover (Flatpak only), and Flatpak support. See [BUILD-STATUS.md](BUILD-STATUS.md) for details.**
